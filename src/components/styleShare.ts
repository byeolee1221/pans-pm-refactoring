...
export const AuthForm = "w-full md:w-[37rem] h-auto border-2 border-solid rounded-lg flex flex-col mt-7 pb-10";

export const FormItem = "flex items-center gap-8 md:gap-14 justify-center mt-4 px-1 md:px-0";
